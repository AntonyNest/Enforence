...
AI-платформа для автоматизованої генерації технічної документації для комерційного та держачного сектору в межах SDLC. 

## Про проєкт

ENFORENCE скорочує час створення ТЗ з тижнів до 15-30 хвилин через multi-agent RAG architecture. Платформа працює в домені Gov Tech специфіки та формує повні технічні завдання для державної сфери України з дотриманням нормативних вимог згідно Постанови КМУ №205.
